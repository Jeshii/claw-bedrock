...
(() => {
	...
	document.getElementById("security-opencode-base").textContent = apiUrlV1;
	document.getElementById("security-opencode-base2").textContent = apiUrlV1;
	document.getElementById("help-curl-base").textContent = apiUrl;
	document.getElementById("help-py-base").textContent = apiUrl;
})();
