...
4. Models are added via the Management UI (port 8282), which writes to `config.local.yaml`. Supported providers: Bedrock (Mantle), OpenRouter, Ollama, and manual entry.
